  ...
  return (
    <>
      ...
      >
        <div
          className={
            isSmall ? "requestWrapper _MrequestWrapper" : "requestWrapper"
          }
        >
            ...
            <div className={"shadow userlistWrapper"} key={index}>
              ...
              <div className={"flex"}>
                {item.type === "INVITE" ? (
                  <>
                    {item.status === "PENDING" && (
                      <Tooltip text={"Request is pending"}>
                        {" "}
                        <SiMinutemailer size={26} color={"white"} />
                      </Tooltip>
                    )}
                    {item.status === "REJECTED" && (
                      <Tooltip text={"Request is rejected"}>
                        {" "}
                        <RiCloseCircleLine size={26} color={"yellow"} />
                      </Tooltip>
                    )}
                    {item.status === "BLOCKED" && (
                      <Tooltip text={"Request is blocked by user"}>
                        {" "}
