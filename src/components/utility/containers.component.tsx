    ...
    >
      ...
      <CustomMargin mt={"10"}>
        <AlignCenter style={{width: "100%", display: "flex"}}>
          <CustomMargin ml={"6"}>
            <OtpCont autoFocus={true} maxLength={1} type={"name"}></OtpCont>
          </CustomMargin>
          <CustomMargin ml={"6"}>
            <OtpCont maxLength={1} type={"name"}></OtpCont>
          </CustomMargin>
          <CustomMargin ml={"6"}>
            <OtpCont maxLength={1} type={"name"}></OtpCont>
          </CustomMargin>
      ...
      <CustomMargin mt={"10"} mr={"20"}>
        <CustomAlign align={"right"}>
          <LinksEl color={"black"} onClick={() => handleback(false)}>
            {getString(enString.backToRegister)}
          </LinksEl>
        </CustomAlign>
      </CustomMargin>
    </FlexBox>
